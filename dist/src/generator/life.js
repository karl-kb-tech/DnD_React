...
var Life = /** @class */ (function () {
    ...
    Life.adventure = function () {
        var r = random_1.Random.percent();
        switch (true) {
            case r < 11: return "You nearly died. You have nasty scars on your body, and you are missing an ear, "
                + (random_1.Random.dice('1d3') + " fingers, or " + random_1.Random.dice('1d4') + " toes.");
            ...
            case r < 41: return 'You contracted a disease while exploring a filthy warren. You recovered from the disease, '
                + 'but you have a persistent cough, pockmarks on your skin, or prematurely gray hair.';
            case r < 51: return 'You were poisoned by a trap or a monster. '
                + 'You recovered, but the next time you must make a saving throw against poison, you make the saving throw with disadvantage.';
            ...
            case r < 71: return 'You were terribly frightened by something you encountered and ran away, '
                + 'abandoning your companions to their fate.';
            case r < 81: return 'You learned a great deal during your adventure. ' +
                'The next time you make an ability check or a saving throw, you have advantage on the roll.';
            case r < 91: return "You found some treasure on your adventure. You have " + random_1.Random.dice('2d6') + " gp left from your share of it.";
            case r < 100: return "You found a considerable amount of treasure on your adventure. "
                + ("You have " + (random_1.Random.dice('1d20') + 50) + " gp left from your share of it.");
            default: return 'You came across a common magic item';
        }
    };
    Life.arcane = function () {
        switch (random_1.Random.dice('1d10')) {
    ...
    Life.boon = function () {
        switch (random_1.Random.dice('1d10')) {
            ...
            case 2: return 'You saved the life of a commoner, who now owes you a life debt. This individual accompanies you '
                + 'on your travels and performs mundane tasks for you, but will leave if neglected, abused, or imperiled.';
            case 3: return 'You found a riding horse.';
            case 4: return "You found some money. You have " + random_1.Random.dice('1d20') + " gp in addition to your regular starting funds.";
            case 5: return 'A relative bequeathed you a simple weapon of your choice.';
            case 6: return 'You found ' + item_1.Items.trinket();
            case 7: return 'You once performed a service for a local temple. '
                + 'The next time you visit the temple, you can receive healing up to your hit point maximum.';
            ...
            case 10: return "A distant relative left you a stipend that enables you to live at the comfortable lifestyle for "
                + (random_1.Random.dice('1d20') + " years. If you choose to live at a higher lifestyle, ")
                + "you reduce the price of the lifestyle by 2 gp during that time period.";
        }
    };
    Life.crime = function () {
        switch (random_1.Random.dice('1d8')) {
    ...
    Life.possessedCreature = function () {
        switch (random_1.Random.dice('1d6')) {
    ...
    Life.punishment = function () {
        var r = random_1.Random.dice('1d12');
        switch (true) {
            ...
            case r < 13: return "You were caught and convicted. You spent time in jail, chained to an oar, or performing hard labor. "
                + ("You served a sentence of " + random_1.Random.dice('1d4') + " years or succeeded in escaping after that much time.");
        }
    };
    Life.supernatural = function () {
        var r = random_1.Random.percent();
        switch (true) {
            case r < 6: return "You were ensorcelled by a fey and enslaved for " + random_1.Random.dice('1d6') + " years before you escaped.";
            case r < 11: return 'You saw a demon and ran away before it could do anything to you.';
            case r < 16: return "A devil tempted you. Make a DC 10 Wisdom saving throw. On a failed save, your alignment shifts one step toward "
                + ("evil (if it's not evil already), and you start the game with an additional " + (random_1.Random.dice('1d20') + 50) + " gp.");
            ...
            case r < 41: return 'You witnessed a falling red star, a face appearing in the frost, or some other bizarre happening. '
            ...
            case r < 76: return "You were briefly possessed by a " + Life.possessedCreature() + ".";
    ...
    Life.tragedy = function () {
        switch (random_1.Random.dice('1d12')) {
            case 1:
            case 2: return "A family member or a close friend died. Cause of death: " + Life.causeOfDeath() + ".";
            case 3:
                return 'A friendship ended bitterly, and the other person is now hostile to you. '
                    + 'The cause might have been a misunderstanding or something you or the former friend did.';
            case 4: return 'You lost all your possessions in a disaster, and you had to rebuild your life.';
            case 5:
                return "You were imprisoned for a crime you didn't commit and spent " + random_1.Random.dice('1d6') + " years at hard labor, "
                    + "in jail, or shackled to an oar in a slave galley.";
            case 6:
                return 'War ravaged your home community, reducing everything to rubble and ruin. in the aftermath, '
            ...
            case 8:
                return 'A terrible blight in your home community caused crops to fail, and many starved. '
                    + 'You lost a sibling or some other family member.';
            case 9: return 'You did something that brought terrible shame to you in the eyes of your family. '
                + 'You might have been involved in a scandal, dabbled in dark magic, or offended someone important. '
                + 'The attitude of your family members toward you becomes indifferent at best, though they might eventually forgive you.';
            case 10: return 'For a reason you were never told, you were exiled from your community.'
                + 'You then either wandered in the wilderness for a time or promptly found a new place to live.';
            case 11: return 'A romantic relationship ended. ' + (random_1.Random.bool() ? 'with bad feelings.' : 'but it was amicable.');
            case 12: return "A current or prospective romantic partner of yours died. "
                + ("Cause of death: " + Life.causeOfDeath() + ".") + (random_1.Random.bool(8) ? ' It was your fault.' : '');
        }
    };
    Life.causeOfDeath = function () {
        switch (random_1.Random.dice('1d12')) {
    ...
    Life.weirdStuff = function () {
        switch (random_1.Random.dice('1d12')) {
            case 1: return "You were turned into a toad and remained in that form for " + random_1.Random.dice('1d4') + " weeks.";
            case 2: return 'You were petrified and remained a stone statue for a time until someone freed you.';
            case 3: return "You were enslaved by a hag, a satyr, or some other being and lived in that creature's thrall"
                + (" for " + random_1.Random.dice('1d6') + " years.");
            case 4: return "A dragon held you as a prisoner for " + random_1.Random.dice('1d12') + " months until adventurers killed it.";
            case 5: return 'You were taken captive by a race of evil humanoids such as drow, kuo-toa, or quaggoths. '
            ...
            case 7: return "You went insane for " + random_1.Random.dice('1d6') + " years and recently regained your sanity. "
                + "A tic or some other bit of odd behavior might linger.";
            case 8: return "A lover of yours was secretly a " + Life.metallic() + " dragon.";
            case 9: return 'You were captured by a cult and nearly sacrificed on an altar to the foul being the cultists served. '
    ...
    Life.event = function (previous) {
        var r = random_1.Random.percent();
        previous.push(r);
        switch (true) {
            case r < 11: return Life.tragedy();
            case r < 21: return Life.boon();
            case r < 31: return (previous.filter(function (n) { return n < 31 && n >= 21; }).length > 1) ? 'You had a child.' : 'You fell in love or got married.';
            case r < 41: return "You made an enemy of an adventuring " + class_1.Classes.random().name + " "
                + (random_1.Random.bool() ? 'but it wasn\'t your fault.' : 'and it was your fault.');
            case r < 51: return "You made a friend of an adventuring " + class_1.Classes.random().name + ".";
            case r < 71: return "You spent time working in a job related to your background."
                + (" Start the game with an extra " + random_1.Random.dice('2d6') + " gp.");
            case r < 76: return 'You met someone important.';
            case r < 81: return 'You went on an adventure. ' + Life.adventure();
            case r < 86: return Life.supernatural();
            case r < 91: return 'You fought in a battle. ' + Life.war();
            case r < 96: return "You were accused of " + Life.crime() + "." + Life.punishment() + " ";
            case r < 100: return Life.arcane();
            default: return Life.weirdStuff();
        }
    };
    Life.occupation = function () {
        var r = random_1.Random.percent();
        switch (true) {
            case r < 6: return 'works as an academic';
            case r < 11: return 'works as an adventuring ' + class_1.Classes.random().name;
    ...
    Life.relationship = function () {
        var r = random_1.Random.dice('3d4');
        switch (true) {
    ...
    Life.status = function () {
        var r = random_1.Random.dice('3d6');
        switch (true) {
            case r < 4: return 'dead. ' + Life.causeOfDeath() + '.';
    ...
    Life.age = function () {
        var r = random_1.Random.percent();
        switch (true) {
            case r < 21: return random_1.Random.numberBetween(16, 20);
            case r < 60: return random_1.Random.numberBetween(21, 30);
            case r < 70: return random_1.Random.numberBetween(31, 40);
            case r < 90: return random_1.Random.numberBetween(41, 50);
            case r < 100: return random_1.Random.numberBetween(51, 60);
            default: return random_1.Random.numberBetween(61, 100);
        }
    };
    Life.relativeAge = function () {
        var r = random_1.Random.dice('2d6');
        switch (true) {
    ...
    Life.childhood = function (charismaModifier) {
        var r = random_1.Random.dice('3d6') + charismaModifier;
        switch (true) {
    ...
    Life.eventCount = function (age) {
        switch (true) {
            case age < 21: return 1;
            case age < 60: return random_1.Random.dice('1d4');
            case age < 70: return random_1.Random.dice('1d6');
            case age < 90: return random_1.Random.dice('1d8');
            case age < 100: return random_1.Random.dice('1d10');
            default: return random_1.Random.dice('1d12');
        }
    };
    return Life;
}());
